...
namespace HtmlHelpers
{
    ...
    {
        private const string _virtualFolder = "wwwroot/";
        ...
        public static HtmlString Unpack(string baseFolder, string bundlePath)
        {
            ...
            var inputFiles = bundle.InputFiles.Select(file => file.StartsWith(_virtualFolder) ? file.Substring(_virtualFolder.Length) : file).ToList(); ;
