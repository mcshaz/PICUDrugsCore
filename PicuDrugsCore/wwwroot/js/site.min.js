 ...
 * Licensed MIT
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery","smartmenus"],n):typeof module=="object"&&typeof module.exports=="object"?module.exports=n(require("jquery")):n(jQuery)})(function(n){return n.extend(n.SmartMenus.Bootstrap={},{keydownFix:!1,init:function(){var t=n("ul.navbar-nav:not([data-sm-skip])");if(t.each(function(){var t=n(this),i=t.data("smartmenus"),f;if(!i){t.smartmenus({subMenusSubOffsetX:2,subMenusSubOffsetY:-6,subIndicators:!1,collapsibleShowFunction:null,collapsibleHideFunction:null,rightToLeftSubMenus:t.hasClass("navbar-right"),bottomToTopSubMenus:t.closest(".navbar").hasClass("navbar-fixed-bottom")}).on({"show.smapi":function(t,i){var r=n(i),u=r.dataSM("scroll-arrows");u&&u.css("background-color",n(document.body).css("background-color"));r.parent().addClass("open")},"hide.smapi":function(t,i){n(i).parent().removeClass("open")}});function u(){t.find("a.current").parent().addClass("active");t.find("a.has-submenu").each(function(){var t=n(this);t.is('[data-toggle="dropdown"]')&&t.dataSM("bs-data-toggle-dropdown",!0).removeAttr("data-toggle");t.is('[role="button"]')&&t.dataSM("bs-role-button",!0).removeAttr("role")})}u();function e(){t.find("a.current").parent().removeClass("active");t.find("a.has-submenu").each(function(){var t=n(this);t.dataSM("bs-data-toggle-dropdown")&&t.attr("data-toggle","dropdown").removeDataSM("bs-data-toggle-dropdown");t.dataSM("bs-role-button")&&t.attr("role","button").removeDataSM("bs-role-button")})}i=t.data("smartmenus");i.isCollapsible=function(){return!/^(left|right)$/.test(this.$firstLink.parent().css("float"))&&this.$root.css("display")=="block"};i.refresh=function(){n.SmartMenus.prototype.refresh.call(this);u();r(!0)};i.destroy=function(t){e();n.SmartMenus.prototype.destroy.call(this,t)};t.is("[data-sm-skip-collapsible-behavior]")&&(i.opts.collapsibleBehavior="toggle");function r(n){var u=i.getViewportWidth(),r;(u!=f||n)&&(r=t.find(".caret"),i.isCollapsible()?(t.addClass("sm-collapsible"),t.is("[data-sm-skip-collapsible-behavior]")||r.addClass("navbar-toggle sub-arrow")):(t.removeClass("sm-collapsible"),t.is("[data-sm-skip-collapsible-behavior]")||r.removeClass("navbar-toggle sub-arrow")),f=u)}r();n(window).on("resize.smartmenus"+i.rootId,r)}}),t.length&&!n.SmartMenus.Bootstrap.keydownFix){if(n(document).off("keydown.bs.dropdown.data-api",".dropdown-menu"),n.fn.dropdown&&n.fn.dropdown.Constructor)n(document).on("keydown.bs.dropdown.data-api",'.dropdown-menu:not([id^="sm-"])',n.fn.dropdown.Constructor.prototype.keydown);n.SmartMenus.Bootstrap.keydownFix=!0}}}),n(n.SmartMenus.Bootstrap.init),n});
